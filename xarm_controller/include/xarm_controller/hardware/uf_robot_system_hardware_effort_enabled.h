...
#ifndef __UF_ROBOT_SYSTEM_HARDWARE_EFFORT_ENABLED_INTERFACE_H__
#define __UF_ROBOT_SYSTEM_HARDWARE_EFFORT_ENABLED_INTERFACE_H__
...
namespace uf_robot_hardware
{
    ...
    class UFRobotSystemHardwareEffortEnabled : public hardware_interface::SystemInterface
    {
    public:
        RCLCPP_SHARED_PTR_DEFINITIONS(UFRobotSystemHardwareEffortEnabled)
...
PLUGINLIB_EXPORT_CLASS(uf_robot_hardware::UFRobotSystemHardwareEffortEnabled, hardware_interface::SystemInterface)

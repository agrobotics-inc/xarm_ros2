...
namespace uf_robot_hardware
{
    ...
    int UFRobotSystemHardwareEffortEnabled::_call_request(std::shared_ptr<ServiceT> client, SharedRequest req, SharedResponse& res)
    {
    ...
    void UFRobotSystemHardwareEffortEnabled::_init_ufactory_driver(void)
    {
    ...
    CallbackReturn UFRobotSystemHardwareEffortEnabled::on_init(const hardware_interface::HardwareInfo& info)
    {
    ...
    std::vector<hardware_interface::StateInterface> UFRobotSystemHardwareEffortEnabled::export_state_interfaces()
    {
    ...
    std::vector<hardware_interface::CommandInterface> UFRobotSystemHardwareEffortEnabled::export_command_interfaces()
    {
    ...
    CallbackReturn UFRobotSystemHardwareEffortEnabled::on_activate(const rclcpp_lifecycle::State& previous_state)
    {
    ...
    CallbackReturn UFRobotSystemHardwareEffortEnabled::on_deactivate(const rclcpp_lifecycle::State& previous_state)
    {
    ...
    hardware_interface::return_type UFRobotSystemHardwareEffortEnabled::read(const rclcpp::Time & time, const rclcpp::Duration &period)
    {
        read_cnts_ += 1;
    ...
    hardware_interface::return_type UFRobotSystemHardwareEffortEnabled::write(const rclcpp::Time & time, const rclcpp::Duration &period)
    {
        if (_need_reset()) {
    ...
    void UFRobotSystemHardwareEffortEnabled::_reload_controller(void) {
    ...
    bool UFRobotSystemHardwareEffortEnabled::_check_cmds_is_change(float *prev, float *cur, double threshold)
	{
		for (int i = 0; i < 7; i++) {
    ...
    bool UFRobotSystemHardwareEffortEnabled::_xarm_is_ready_read(void)
    {
    ...
    bool UFRobotSystemHardwareEffortEnabled::_xarm_is_ready_write(void)
    {
    ...
    bool UFRobotSystemHardwareEffortEnabled::_firmware_version_is_ge(int major, int minor, int revision)
	{
    ...
    bool UFRobotSystemHardwareEffortEnabled::_need_reset()
    {
